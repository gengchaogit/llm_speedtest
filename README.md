...
*   **详细性能指标**：测量提示词长度、预填充耗时、预填充速度、输出 Token 数、输出耗时、输出速度。
...
1.  将 `index.html` 文件保存到你的本地计算机。
2.  使用任何现代浏览器（如 Chrome, Firefox, Edge）打开 `index.html` 文件。无需额外的安装或服务器。
