...
*   **📁 双语言文件版本**：
    *   `本地大模型推理速度测试工具v1.8.html` - 中文版（默认中文界面）
    *   `LLM_Speed_Test_Tool_v1.8_EN.html` - 英文版（默认英文界面）
...
1.  **选择你偏好的版本**：
    *   默认英文界面：下载 `LLM_Speed_Test_Tool_v1.8_EN.html`
    *   默认中文界面：下载 `本地大模型推理速度测试工具v1.8.html`
